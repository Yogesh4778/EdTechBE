...
export const Registration = ChacheError(
...
export const ActivateUser = ChacheError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const loginUser = ChacheError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const LogoutUser = ChacheError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const UpadteAccessToken = ChacheError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (!sessions) {
        return next(
          new ErrorHandling(
            "Please login to access this website(user.controller.ts)",
            400
          )
        );
      }
...
export const userInfo = ChacheError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const userId = req.user?._id || "";
...
export const SocialAuth = ChacheError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const UpdateUserInfo = ChacheError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const UpdatePassword = ChacheError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (!oldPassword || !newPassword) {
        return next(
          new ErrorHandling("Please enter old and new Password", 400)
        );
      }
...
export const UpdateProfile = ChacheError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getAllUsers = ChacheError(
...
export const updateAllUsers = ChacheError(
  async (res: Response, req: Request, next: NextFunction) => {
    try {
...
export const DeleteUser = ChacheError(
  async (res: Response, req: Request, next: NextFunction) => {
    try {
      const { id } = req.params;
